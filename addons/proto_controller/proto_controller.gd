...
@export var input_forward : String = "moveForward"
## Name of Input Action to move Backward.
@export var input_back : String = "moveBack"
...
func enter_car(car: VehicleBody3D):
	is_driving = true
	current_car = car
	...
	car.get_node("CamArm/Camera3D").current = true
	car.get_node("CamArm").active = true
...
func exit_car():
	...
	# Disable car
	current_car.is_driven = false
	current_car.get_node("CamArm").active = false
	
	# Camera switch back
	$Head/Camera3D.current = true
	current_car.get_node("CamArm/Camera3D").current = false
